  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900">⚡ Hourly Usage Dashboard</h1>
        <p className="text-gray-600 mt-2">Unlimited AI generations at $15/hour for advanced users</p>
      </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-semibold text-blue-900 mb-2">⚡ Hourly Unlimited Features:</h4>
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>✅ Unlimited AI generations</li>
                  <li>✅ Premium model access</li>
                  <li>✅ No daily limits</li>
                  <li>✅ Pause/Resume anytime</li>
                  <li>✅ Minimum 1-hour billing (even for 5 mins usage)</li>
